export default {
    ...
    subjectCardHeaders: {
      nameInPolish: 'Nazwa w języku polskim',
        ...
        educationalEffects: 'Efekty kształcenia',
        curriculum: 'Treści programowe',
        trackingMatrix: 'Macierz przekształceń',
        newObjectivity: 'Nowy cel',
        schedule: 'Rozkład zajęć',
        yes: 'Tak',
        no: 'Nie',
        obligatory: 'Obowiązkowe',
        optional: 'Opcjonalny',
        universityWide: 'Ogólnouczelniany',
